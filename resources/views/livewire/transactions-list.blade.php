<table class="w-full ">
    ...
    @foreach($this->transactions as $transaction)
        <tr class="border-b-2" wire:key="{{ $transaction->id }}">
            ...
            <td>
                <span
                    class="{{ $transaction->amount > 0 ? "bg-green-600" : "bg-red-500"}} p-2 rounded-3xl text-white font-bold flex justify-center max-w-20 mt-2 mb-2">
            ...
            <td>
                @can('edit transaction')
                    <button type="button" title="Modifier"
                        ...
                        <svg class="hover:stroke-orange-500 stroke-black dark:stroke-white dark:hover:stroke-orange-500"
            ...
            <td>
                @can('delete transaction')
                    <button type="button" title="Supprimer"
                        ...
                        <svg class="hover:stroke-red-500 stroke-black dark:stroke-white dark:hover:stroke-red-500"
                             xmlns="http://www.w3.org/2000/svg" width="24"
                             height="24" viewBox="0 0 24 24" fill="none">
